...
namespace 乾燥炉点検アプリ
{
    public partial class 機番2_画面 : Form
    {
        ...
        private void 機番2_画面_Load(object sender, EventArgs e)
        {
            label12.Text = Global.Uname + " 様";
            ...
            else
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        command.CommandText += "毎日日付3桁連番 , 乾燥炉機番 , 点検作業者 , 日常点検日時 , 点検項目1_オイル量 , 点検項目2_ポンプ音 , 点検項目3_昇温 , 点検項目4_真空引き , 異常有無 ";
        ...
        private void 機番2_画面_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();        }
    }
}
